    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Spiral\Attributes\ReaderInterface' => \Spiral\Attributes\AttributeReader::class,
            'Spiral\RoadRunnerLaravel\Temporal\DeclarationRegistryInterface' => \Spiral\RoadRunnerLaravel\Temporal\DeclarationRegistry::class,
            'Temporal\Interceptor\PipelineProvider' => \Temporal\Interceptor\SimplePipelineProvider::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/ranen/workspace/php/laravel-roadrunner-skeleton/public/storage' => 'string',
            'horizon.name' => 'string',
            'horizon.domain' => 'NULL',
            'horizon.path' => 'string',
            'horizon.use' => 'string',
            ...
            'roadrunner.cache.storage' => 'string',
            'roadrunner.grpc.services' => 'array',
            'roadrunner.temporal.address' => 'string',
            'roadrunner.temporal.defaultWorker' => 'string',
            'roadrunner.temporal.workers' => 'array',
            'roadrunner.temporal.declarations' => 'array',
            'roadrunner.workers.http' => 'string',
            'roadrunner.workers.jobs' => 'string',
            'roadrunner.workers.grpc' => 'string',
            'roadrunner.workers.temporal' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/ranen/workspace/php/laravel-roadrunner-skeleton/public/storage','horizon.name','horizon.domain',
...
'octane.watch','octane.garbage','octane.max_execution_time','queue.default','queue.connections.sync.driver',
...
'queue.batching.table','queue.failed.driver','queue.failed.database','queue.failed.table','roadrunner.cache.storage',
'roadrunner.grpc.services','roadrunner.temporal.address','roadrunner.temporal.defaultWorker','roadrunner.temporal.workers','roadrunner.temporal.declarations',
'roadrunner.workers.http','roadrunner.workers.jobs','roadrunner.workers.grpc','roadrunner.workers.temporal','services.postmark.token',
...
'horizon.jobs.show','horizon.index','generated::NIONIfTVRkzUB962','generated::7vcSJnAwHpNOIM05','storage.local',);
        registerArgumentsSet('views', 
'welcome','horizon::layout','laradumps::output','laradumps::summary','laravel-exceptions::401',
...
'BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_STORE','REDIS_CLIENT',
'REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','OCTANE_SERVER',);
